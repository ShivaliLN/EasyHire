...
const App = ({ isServerInfo }) => {
  ...
  return (
    <Layout
      style={{ height: "100vh", overflow: "auto", background: "#bcc9ec" }}
    >
      <Router>
      ...
      <Footer style={{ textAlign: "center", background: "#bcc9ec" }}>
        <Typography.Title level={5}>
          <Text style={{ display: "block" }}>
            Made with ❤️ at Chainlink Fall Hackathon 2022
          </Text>
        </Typography.Title>
      </Footer>
    </Layout>
...
export const Logo = () => (
  <div style={{ display: "flex" }}>
    <Image width={350} height={350} src="logo.png">
      {" "}
    </Image>
    {/*
    <svg
